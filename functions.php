...
function getinfo($subject,$date,$first,$last,$school){  
    ...
    if($subject==''){
       ...
       $query = "select publication.citation, faculty.last_name, faculty.first_name,school.name from publication 
        ...
        faculty.last_name like '%$last%' AND faculty.first_name LIKE '%$first%'
        ORDER BY school.name, faculty.last_name ASC";
       }
       else{
           $query = "select publication.citation, faculty.last_name, faculty.first_name,school.name from publication 
               inner join faculty_publication on publication.id=faculty_publication.publication_id
               ...
               inner join faculty_school on faculty.id=faculty_school.faculty_id 
               inner join school on faculty_school.school_id = school.id 
               where publication.publication_date = $date
               AND school.id=$school AND faculty.last_name like '%$last%' AND faculty.first_name LIKE '%$first%'
               ORDER BY faculty.last_name ASC";
       }
    }else{
    if($school==''){
          $query = "select publication.citation, faculty.last_name, faculty.first_name, school.name from publication
              ...
              inner join faculty_school on faculty.id=faculty_school.faculty_id 
              inner join school on faculty_school.school_id = school.id
              where publication.publication_type_id = $subject AND publication.publication_date = $date AND
            ...
            $query = "select publication.citation, faculty.last_name, faculty.first_name, school.name from publication 
                ...
                inner join faculty_school on faculty.id=faculty_school.faculty_id 
                inner join school on faculty_school.school_id = school.id 
                where publication.publication_type_id = $subject AND publication.publication_date = $date
                AND school.id=$school AND faculty.last_name like '%$last%' AND faculty.first_name LIKE '%$first%'
                ORDER BY faculty.last_name ASC";
